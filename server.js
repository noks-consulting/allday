...
const ADMIN_PASS = process.env.ADMIN_PASSWORD || 'Allday62003?!';
...
// ─────────────────────────────────────────────
function injectProtection(html, client) {
...
app.get('/p/*', (req, res) => {
  ...
  html = injectProtection(html, found.client);
